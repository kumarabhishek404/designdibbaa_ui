...
const Navbar = () => {
  ...
  const [navigation, setNavigation] = useState([
    ...
    { name: "Textures", href: "/textures", current: false },
    { name: "Models", href: "/models", current: false },
    { name: "Animations", href: "/animations", current: false },
  ...
  return (
    <div className="overflow-hidden fixed w-full z-10 shadow-lg">
      <Disclosure as="nav" className="bg-[#ffff00]">
        {({ open }) => (
          <>
              ...
              <div className="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                {navigation.map((item) => (
                  <Disclosure.Button
                    ...
                    as="link"
                    onClick={() => {
                      console.log("Click on", item.href)
